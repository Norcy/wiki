...
为什么不能直接调用 `method_exchangeImplementations`

参见：[方法交换的图示](https://dandan2009.github.io/2018/04/08/runtime-method-swizzling/)

1. 方法交换为什么写在 +load 中而不是 initialze
2. 方法交换为什么要 dispatch_once 中执行

参见：[iOS 的 initialize 和 load 区别](https://norcy.github.io/wiki/iOS/iOS%20%E7%9A%84%20initialize%20%E5%92%8C%20load%20%E5%8C%BA%E5%88%AB/#load)
